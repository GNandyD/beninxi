  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Livraison */}
        <div style={{ padding: '14px 24px', background: '#FAFAFA', borderBottom: '1px solid #F5F5F5' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '0.8rem', color: '#555', fontWeight: 700, fontFamily: 'var(--font-sora)' }}>
            Livraison calculée selon la ville choisie.
          </div>
        </div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 24px' }}>
          {items.length === 0 ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 16, padding: '40px 0' }}>
              <div style={{ fontSize: '2.8rem', fontWeight: 900, color: '#111' }}>Bag</div>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', border: '1px solid #E8E8E8', borderRadius: 10, overflow: 'hidden', background: '#fff' }}>
                        <button onClick={() => updateQty(item, item.qty - 1)} style={{ width: 30, height: 30, border: 'none', background: 'none', cursor: 'pointer', fontSize: '1rem', color: '#0A0A0A', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>−</button>
          ...
          <div style={{ padding: '20px 24px', borderTop: '1px solid #F5F5F5', background: '#fff' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 16 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', paddingTop: 12, borderTop: '1px solid #F0F0F0', marginTop: 4 }}>
                <span style={{ fontFamily: 'var(--font-sora)', fontWeight: 800, fontSize: '1rem', color: '#0A0A0A' }}>Total estimé</span>
                <span style={{ fontFamily: 'var(--font-sora)', fontWeight: 800, fontSize: '1.15rem', color: '#1B5E20' }}>Selon votre ville</span>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 8, marginTop: 14, flexWrap: 'wrap' }}>
              {['MTN Money', 'Moov Money', 'Carte'].map(p => (
